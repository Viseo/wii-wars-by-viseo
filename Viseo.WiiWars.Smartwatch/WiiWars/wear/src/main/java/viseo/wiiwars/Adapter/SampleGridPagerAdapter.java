...
import viseo.wiiwars.Fragment.ColorFragment;
import viseo.wiiwars.Fragment.ScoreFragment;
import viseo.wiiwars.Fragment.ShapeFragment;
import viseo.wiiwars.Fragment.TurnOnFragment;
import viseo.wiiwars.Fragment.VoiceFragment;
...
public class SampleGridPagerAdapter extends FragmentGridPagerAdapter {
    ...
    public SampleGridPagerAdapter(Context ctx, FragmentManager fm) {
        ...
        mRows.add(new Row(cardFragment(R.string.mainpage_title, R.string.mainpage_desc)));
        mRows.add(new Row(new ScoreFragment()));
        mRows.add(new Row(new TurnOnFragment(),new ColorFragment(),new ShapeFragment()));
        mRows.add(new Row(cardFragment(R.string.vocalSearchTitle, R.string.vocalSearchDesc)));
        mRows.add(new Row(new VoiceFragment()));
    ...
    LruCache<Point, Drawable> mPageBackgrounds = new LruCache<Point, Drawable>(3) {
        ...
        protected Drawable create(final Point page) {
            ...
            if (page.y == 2 && page.x == 1) {
                int resid = R.drawable.background1;
                new DrawableLoadingTask(mContext) {
                    @Override
                    protected void onPostExecute(Drawable result) {
                        TransitionDrawable background = new TransitionDrawable(new Drawable[] {
