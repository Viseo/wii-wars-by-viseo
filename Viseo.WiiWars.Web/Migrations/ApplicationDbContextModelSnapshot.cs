...
using Viseo.WiiWars.Web.Models;

namespace Viseo.WiiWars.Web.Migrations
{
    [ContextType(typeof(Viseo.WiiWars.Web.Models.ApplicationDbContext))]
    public class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public override IModel Model
        {
            get
            {
                ...
                builder.Entity("Viseo.WiiWars.Web.Models.ApplicationUser", b =>
                {
                ...
                builder.Entity("Microsoft.AspNet.Identity.IdentityUserClaim`1[[System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]]", b =>
                {
                    b.ForeignKey("Viseo.WiiWars.Web.Models.ApplicationUser", "UserId");
                });
